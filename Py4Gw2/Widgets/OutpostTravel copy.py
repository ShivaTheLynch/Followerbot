...
# Extract outpost names from the dictionary keys
...
def DrawWindow():
    ...
    if PyImGui.begin(window_module.window_name, window_module.window_flags):
        try:
            ...
            # Outpost selection dropdowns organized by campaign
            campaigns = {
                "Global": ["[Global] Embark Beach", "[Global] Great Temple of Balthazar"],
                "Pre-Searing": ["[Pre] Ascalon City", "[Pre] Ashford Abbey", "[Pre] Foible's Fair", "[Pre] Fort Ranik", "[Pre] The Barradin Estate"],
                "Prophecies": ["[Proph] Ascalon City", "[Proph] Ruins of Surmia", "[Proph] Fort Ranik", "[Proph] Frontier Gate", "[Proph] Grendich Courthouse", "[Proph] Piken Square", "[Proph] Lion's Arch", "[Proph] Bergen Hot Springs", "[Proph] Beetletun", "[Proph] Temple of the Ages", "[Proph] Fishermen's Haven", "[Proph] Ventari's Refuge", "[Proph] Druids Overlook", "[Proph] Quarrel Falls", "[Proph] The Wilds", "[Proph] Aurora Glade", "[Proph] Maguuma Stade", "[Proph] Henge of Denravi", "[Proph] Kryta Province", "[Proph] Gates of Kryta", "[Proph] D'Alessio Seaboard", "[Proph] Sanctum Cay", "[Proph] Droknar's Forge", "[Proph] Camp Rankor", "[Proph] Ice Tooth Cave", "[Proph] Beacon's Perch", "[Proph] Yak's Bend", "[Proph] Borlis Pass", "[Proph] The Granite Citadel", "[Proph] Marhan's Grotto", "[Proph] Port Sledge"],
                "Factions": ["[Fact] Kaineng Center", "[Fact] Shing Jea Monastery", "[Fact] Seitung Harbor", "[Fact] Tsumei Village", "[Fact] Ran Musu Gardens", "[Fact] Maatu Keep", "[Fact] Zin Ku Corridor", "[Fact] Senji's Corner", "[Fact] Vizunah Square", "[Fact] Dragon's Throat", "[Fact] Nahpui Quarter", "[Fact] Tahnnakai Temple", "[Fact] Arborstone", "[Fact] Boreas Seabed", "[Fact] Sunjiang District", "[Fact] Raisu Palace", "[Fact] Imperial Sanctum", "[Fact] Marketplace", "[Fact] Bejunkan Pier", "[Fact] Cavalon", "[Fact] House zu Heltzer", "[Fact] Jade Flats (Kurzick)", "[Fact] Jade Flats (Luxon)", "[Fact] Aspenwood Gate (Kurzick)", "[Fact] Aspenwood Gate (Luxon)"],
                "Nightfall": ["[NF] Kamadan, Jewel of Istan", "[NF] Champion's Dawn", "[NF] Kodlonu Hamlet", "[NF] Beknur Harbor", "[NF] Consulate", "[NF] Sunspear Great Hall", "[NF] Mihanu Township", "[NF] Blacktide Den", "[NF] Kodash Bazaar", "[NF] Dzagonur Bastion", "[NF] Chantry of Secrets", "[NF] Gate of Desolation", "[NF] Gate of Pain", "[NF] Gate of Madness", "[NF] Gate of Torment", "[NF] Gate of Anguish", "[NF] Sunspear Sanctuary"],
                "Eye of the North": ["[EOTN] Eye of the North", "[EOTN] Gunnar's Hold", "[EOTN] Sifhalla", "[EOTN] Olafstead", "[EOTN] Rata Sum", "[EOTN] Central Transfer Chamber", "[EOTN] Gadd's Encampment", "[EOTN] Tarnished Haven", "[EOTN] Umbral Grotto"],
                "Challenge Missions & Elite Areas": ["[Elite] Urgoz's Warren", "[Elite] The Deep"]
            }

            for campaign, outposts_list in campaigns.items():
                PyImGui.text(campaign)
                current_index = widget_config.selected_outpost_index if outpost_names[widget_config.selected_outpost_index] in outposts_list else 0
                new_index = PyImGui.combo(f"{campaign} Outposts", current_index, outposts_list)
                if new_index != current_index:
                    widget_config.selected_outpost_index = outpost_names.index(outposts_list[new_index])
